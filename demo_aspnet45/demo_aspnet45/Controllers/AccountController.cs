...
namespace demo_aspnet45.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (userlogin != null)
            {
                ...
                Session["NickName"] = "";
                Session["USE_Id"] = "";
                var uud = db.UserDetails.Where(x => x.USE_Usercode == userlogin.USE_Usercode).FirstOrDefault();
                if (uud == null)
                {
                    return RedirectToAction("createUserDetail", "UserDetail", new { id = userlogin.Id });
                }
                else
                {
