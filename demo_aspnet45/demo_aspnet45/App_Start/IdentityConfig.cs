...
using demo_aspnet45.Models;
using System.Net.Mail;
using System.Configuration;
using System.Net.Mime;
using Microsoft.Owin.Security.DataProtection;

namespace OCTWEB_NET45.App_Start
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            string html = "<strong style='font-size:20px'>" + message.Subject + "</strong>"
                         + "<p style='font-size: 20px'>This process is for your OCTWEB Registration/Login Application Account, click the link below: "
                         + "<a href=\"" + message.Body + "\">link</a></p><br/>"
                         + "<a href=\"" + message.Body + "\">" + message.Body + "</a><br/>"
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public static ApplicationUserManager Create(IdentityFactoryOptions<ApplicationUserManager> options, IOwinContext context)
        {
            ...
            var provider = new DpapiDataProtectionProvider("OCTWEB"); //SampleAppName

            manager.UserTokenProvider = new DataProtectorTokenProvider<ApplicationUser>(
                provider.Create("OCTWEBToken")); //SampleTokenName
